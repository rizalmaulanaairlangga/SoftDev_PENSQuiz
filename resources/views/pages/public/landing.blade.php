    ...
    <main class="min-h-screen overflow-x-hidden bg-[#eaf2f8] font-sans text-slate-900">
        <header data-landing-header class="fixed inset-x-0 top-0 z-50 bg-transparent transition-colors duration-300">
            <div class="mx-auto flex max-w-7xl items-center justify-between gap-6 px-5 py-4 sm:px-8 lg:px-10">
                <a href="#home" data-landing-scroll class="shrink-0 text-2xl font-extrabold text-white focus:outline-none sm:text-[28px]" aria-label="PENSQuiz home">
                    PENS<span class="text-[#fdc02a]">Quiz</span>
                </a>
        ...
        <footer class="bg-[linear-gradient(90deg,#6eacd2_0%,#1a4770_100%)] px-5 py-12 text-white sm:px-8 lg:px-10 lg:pb-10 lg:pt-20">
            <div class="mx-auto max-w-7xl">
                <div class="grid gap-10 border-b border-white/20 pb-12 lg:grid-cols-[1fr_auto] lg:gap-20 lg:pb-16">
                    <div class="max-w-sm">
                        <div class="text-3xl font-extrabold sm:text-[32px]">
                            PENS<span class="text-[#fdc02a]">Quiz</span>
                        </div>
                ...
                <div class="mt-8 flex flex-col gap-5 text-sm font-medium text-white/90 sm:flex-row sm:items-center sm:justify-between">
                    <p>2026 - PENSQuiz - All rights reserved</p>
