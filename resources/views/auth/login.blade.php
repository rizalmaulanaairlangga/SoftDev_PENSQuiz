<x-guest-layout>
    ...
    <main class="min-h-screen bg-[#f8f8f6] px-4 py-4 font-sans text-[#101010] sm:px-6 lg:px-8">
        <div class="mx-auto grid min-h-[calc(100vh-2rem)] max-w-[1600px] gap-6 lg:h-[calc(100vh-2rem)] lg:grid-cols-2 lg:gap-8">
            ...
            {{-- ---------------------------------------------------------------- --}}
            {{-- A. FORM SECTION (KIRI)                                           --}}
            {{-- Berisi form login utama, tampil penuh di mobile/tablet.          --}}
            {{-- ---------------------------------------------------------------- --}}
                    ...
                    <div class="my-auto flex w-full flex-col items-center py-10">
                        <div class="w-full max-w-xl">
                            ...
                            <div class="w-full">
                                ...
                                <h1 class="mt-8 text-5xl font-extrabold leading-none tracking-normal text-black sm:text-6xl lg:text-[68px]">
                                    Welcome back!
                                </h1>

                                <p class="mt-5 text-base font-medium leading-7 text-[#101010] sm:text-lg">
            ...
            {{-- ---------------------------------------------------------------- --}}
            {{-- B. IMAGE / ILLUSTRATION SECTION (KANAN)                          --}}
            {{-- Hanya ditampilkan pada ukuran layar lg (desktop) ke atas.        --}}
            {{-- Disembunyikan pada layar HP/Tablet (ditambah class hidden lg:block)--}}
            {{-- ---------------------------------------------------------------- --}}
            <section class="auth-slide-from-left hidden lg:block relative min-h-[520px] overflow-hidden rounded-[28px] bg-[linear-gradient(180deg,#8fd4f0_0%,#7dc6e9_18%,#5b98d0_52%,#1f4b88_100%)] px-6 py-10 sm:px-10 lg:min-h-0 lg:px-12 lg:py-8">
                <img
                    src="{{ asset('assets/images/img_background.png') }}"
                    alt=""
