<x-guest-layout>
    ...
    {{-- ================================================================ --}}
    {{-- 2. MAIN CONTAINER                                                --}}
    {{-- Wrapper utama dengan responsivitas grid:                         --}}
    {{-- 1 kolom di mobile/tablet, 2 kolom di desktop (lg:grid-cols-2).   --}}
    {{-- ================================================================ --}}
    <main class="min-h-screen bg-[#f8f8f6] px-4 py-3 font-sans text-[#101010] sm:px-6 lg:px-8">
        <div class="mx-auto grid min-h-[calc(100vh-1.5rem)] max-w-[1600px] gap-5 lg:h-[calc(100vh-1.5rem)] lg:grid-cols-2 lg:gap-7">
            ...
            {{-- ---------------------------------------------------------------- --}}
            {{-- A. IMAGE / ILLUSTRATION SECTION (KIRI)                           --}}
            {{-- Hanya ditampilkan pada ukuran layar lg (desktop) ke atas.        --}}
            {{-- Disembunyikan pada layar HP/Tablet (ditambah class hidden lg:block)--}}
            {{-- ---------------------------------------------------------------- --}}
            <section class="auth-slide-from-right hidden lg:block relative min-h-[520px] overflow-hidden rounded-[28px] bg-[linear-gradient(180deg,#8fd4f0_0%,#7dc6e9_18%,#5b98d0_52%,#1f4b88_100%)] px-6 py-8 sm:px-10 lg:min-h-0 lg:px-12 lg:py-7">
                <img
            ...
            {{-- ---------------------------------------------------------------- --}}
            {{-- B. FORM SECTION (KANAN)                                          --}}
            {{-- Berisi form register utama, tampil penuh di mobile/tablet.       --}}
            {{-- ---------------------------------------------------------------- --}}
            <section class="auth-slide-from-left relative overflow-hidden rounded-[28px] bg-[linear-gradient(180deg,#fafcff_0%,#edf5ff_63%,#d4e5fb_100%)] px-6 py-6 sm:px-10 sm:py-7 lg:px-12 lg:py-6 xl:px-16">
                ...
                <div class="relative z-10 mx-auto flex min-h-full flex-col">
                    {{-- Tombol Kembali --}}
                    ...
                    <div class="my-auto flex w-full flex-col items-center py-10">
                        <div class="w-full max-w-3xl">
                            ...
                            <div class="w-full">
                                ...
                                <p class="mt-3 text-base font-medium leading-6 text-[#101010] sm:text-[17px]">
        ...
        {{-- ---------------------------------------------------------------- --}}
        {{-- C. JAVASCRIPT LOGIC                                              --}}
        {{-- Menangani validasi checkbox persetujuan untuk tombol Register    --}}
        {{-- ---------------------------------------------------------------- --}}
        <script>
